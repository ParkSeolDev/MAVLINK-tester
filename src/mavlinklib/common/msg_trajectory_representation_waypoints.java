...
public class msg_trajectory_representation_waypoints extends MAVLinkMessage{
    ...
    public static final int MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_WAYPOINTS_CRC = 91;
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.crc_extra = MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_WAYPOINTS_CRC;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_TRAJECTORY_REPRESENTATION_WAYPOINTS - sysid:"+sysid+" compid:"+compid+" time_usec:"+time_usec+" pos_x:"+pos_x+" pos_y:"+pos_y+" pos_z:"+pos_z+" vel_x:"+vel_x+" vel_y:"+vel_y+" vel_z:"+vel_z+" acc_x:"+acc_x+" acc_y:"+acc_y+" acc_z:"+acc_z+" pos_yaw:"+pos_yaw+" vel_yaw:"+vel_yaw+" valid_points:"+valid_points+"";
    }
}
