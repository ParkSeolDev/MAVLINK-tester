 ...
 *  카메라 홀드
 */
public class DoDigicamHoldMode implements FlightCommand {
    public DoDigicamHoldMode(int index) {
        ...
        message.param1 = 0;
        message.param2  = CUSTOM_CAMERA_TYPE.PRENUW_SMALLCAM_HOLD_COORDICATE_MODE.rawStateData;
        ...
        System.out.println(" DoDigicamHoldMode Alt :: " + message.toString());
