...
public class PreviousPlayTheSpeaker implements FlightCommand {
	
	public PreviousPlayTheSpeaker(int index) {
		...
		message.param2 = CMD_USER_CONTROL_LIST.USER_CONTROL_SPEAKER_PREVIOUS.rawStateData;				//_param2: control input
