 ...
 *  카메라 정면보기
 */
public class DoDigicamFaceMode implements FlightCommand {
    public DoDigicamFaceMode(int index) {
        ...
        message.param1 = 0;
        message.param2  = CUSTOM_CAMERA_TYPE.PRENUW_SMALLCAM_STOW_FACE_MODE.rawStateData;
        ...
        System.out.println(" DoDigicamFaceMode Alt :: " + message.toString());
