...
public class ControlTheSpeaker implements FlightCommand {
	
	public ControlTheSpeaker(int index, int device, float control, float trackNumber) {
		msg_command_long message = new msg_command_long();
		message.target_system = (short)index; //1;
		message.target_component = MAV_COMPONENT.MAV_COMP_ID_ALL; //MAV_COMPONENT.MAV_COMP_ID_ALL; // MAV_COMP_ID_GIMBAL
