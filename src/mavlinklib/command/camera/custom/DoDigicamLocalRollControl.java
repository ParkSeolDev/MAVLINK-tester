 ...
 *  roll 조종
 */
public class DoDigicamLocalRollControl implements FlightCommand {
    public DoDigicamLocalRollControl(int index, int roll ) {
        ...
        System.out.println(" DoDigicamRollControl Alt :: " + message.toString());
