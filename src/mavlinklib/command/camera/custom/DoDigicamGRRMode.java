...
public class DoDigicamGRRMode implements FlightCommand {

    public DoDigicamGRRMode (int index) {
        ...
        message.param2 = CUSTOM_CAMERA_TYPE.PRENUW_SMALLCAM_GRR_MODE.rawStateData;					        //_param2: Zoom Absolute(줌 절대값)
        ...
        System.out.println(" DoDigicamGRRMode Alt :: " + message.toString());
