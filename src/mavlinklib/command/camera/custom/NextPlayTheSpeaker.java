...
public class NextPlayTheSpeaker implements FlightCommand {
	
	public NextPlayTheSpeaker(int index) {
		...
		message.param2 = CMD_USER_CONTROL_LIST.USER_CONTROL_SPEAKER_NEXT.rawStateData;				//_param2: control input
