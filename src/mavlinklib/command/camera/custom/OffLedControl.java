...
public class OffLedControl implements FlightCommand {
	
	public OffLedControl(int index) {
		...
		message.param1 = CUSTOM_DEVICE_LIST.PRENEU_LED.rawStateData;       			//_param1: speacker : 1, led : 2, search lite : 3 ...
		message.param2 = CMD_USER_CONTROL_LIST.USER_CONTROL_LED_OFF.rawStateData;		//_param2: control input
