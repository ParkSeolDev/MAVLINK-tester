 ...
 *  카메라 커스텀모드 설정
 */
public class DoDigicamCustomMode implements FlightCommand {
    public DoDigicamCustomMode(int index, int mode) {
        ...
        System.out.println(" DoDigicamCustomMode Alt :: " + message.toString());
