 ...
 *  카메라 아래보기 (밑 90도)
 */
public class DoDigicamBelowMode implements FlightCommand {
    public DoDigicamBelowMode(int index) {
        ...
        message.param1 = 0;
        message.param2  = CUSTOM_CAMERA_TYPE.PRENUW_SMALLCAM_NADIR_BELOW_MODE.rawStateData;
        ...
        System.out.println(" DoDigicamBelowMode Alt :: " + message.toString());
