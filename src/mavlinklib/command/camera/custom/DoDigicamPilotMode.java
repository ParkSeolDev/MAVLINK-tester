 ...
 *  카메라 밑 80도
 */
public class DoDigicamPilotMode implements FlightCommand {
    public DoDigicamPilotMode(int index) {
        ...
        message.param1 = 0;
        message.param2  = CUSTOM_CAMERA_TYPE.PRENUW_SMALLCAM_PILOT_MODE.rawStateData;
        ...
        System.out.println(" DoDigicamPilotMode Alt :: " + message.toString());
