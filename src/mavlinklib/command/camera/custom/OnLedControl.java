...
public class OnLedControl implements FlightCommand {
	
	public OnLedControl(int index) {
		...
		message.param2 = CMD_USER_CONTROL_LIST.USER_CONTROL_LED_ON.rawStateData;		//_param2: control input
