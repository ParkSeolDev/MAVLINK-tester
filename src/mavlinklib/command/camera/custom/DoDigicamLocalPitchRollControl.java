 ...
 *  pitch와 roll 함께 조종
 */
public class DoDigicamLocalPitchRollControl implements FlightCommand {
    public DoDigicamLocalPitchRollControl(int index, int pitch, int roll ) {
        ...
        message.param1 = 0;
        message.param2  = CUSTOM_CAMERA_TYPE.PRENUW_SMALLCAM_LOCAL_POSITON_MODE.rawStateData;
        ...
        System.out.println(" DoDigicamPitchRollControl Alt :: " + message.toString());
