...
public class OffSearchLiteControl implements FlightCommand {
	
	public OffSearchLiteControl(int index) {
		...
		message.param1 = CUSTOM_DEVICE_LIST.PRENEU_SEARCH_LIGHT.rawStateData;       			//_param1: speacker : 1, led : 2, search lite : 3 ...
		message.param2 = CMD_USER_CONTROL_LIST.USER_CONTROL_LIGHT_OFF.rawStateData;				//_param2: control input
//		message.param3 = IcpUtil.ICP_NAN;		//_param3: trackNumber
