...
public class PlayTheSpeaker implements FlightCommand {
	
	public PlayTheSpeaker(int index, int trackNumber) {
		...
		message.param2 = CMD_USER_CONTROL_LIST.USER_CONTROL_SPEAKER_PLAY.rawStateData;  //_param2: control input
		message.param3 = trackNumber;		    //_param3: trackNumber 0 : current mp
