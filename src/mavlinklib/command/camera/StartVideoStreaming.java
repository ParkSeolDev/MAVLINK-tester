...
public class StartVideoStreaming implements FlightCommand {
	// VIDEO_STREAM_INFORMATION   msg
	// VIDEO_STREAM_STATUS   msg
	public StartVideoStreaming(int index){
		...
		message.command = MAV_CMD.MAV_CMD_VIDEO_START_STREAMING ; //MAV_CMD.MAV_CMD_REQUEST_CAMERA_INFORMATION ;
