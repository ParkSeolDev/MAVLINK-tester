...
import tcpserver.src.mavlinklib.common.msg_camera_information;
...
public class RequestCameraInfoV2 implements FlightCommand {
	
	public RequestCameraInfoV2(int index, int compId) {
		// CAMERA_INFORMATION
...
//	     397: send COMPONENT_METADATA message
		...
		message.param1 = msg_camera_information.MAVLINK_MSG_ID_CAMERA_INFORMATION;    //_param1: request msg id
