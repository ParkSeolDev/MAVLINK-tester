...
package tcpserver.src.mavlinklib;

import java.io.Serializable;

import tcpserver.src.mavlinklib.Messages.MAVLinkMessage;
import tcpserver.src.mavlinklib.Messages.MAVLinkPayload;
import tcpserver.src.mavlinklib.ardupilotmega.CRC;
import tcpserver.src.mavlinklib.ardupilotmega.msg_adap_tuning;
import tcpserver.src.mavlinklib.ardupilotmega.msg_ahrs;
import tcpserver.src.mavlinklib.ardupilotmega.msg_ahrs2;
import tcpserver.src.mavlinklib.ardupilotmega.msg_ahrs3;
import tcpserver.src.mavlinklib.ardupilotmega.msg_airspeed_autocal;
import tcpserver.src.mavlinklib.ardupilotmega.msg_amp_parts;
import tcpserver.src.mavlinklib.ardupilotmega.msg_aoa_ssa;
import tcpserver.src.mavlinklib.ardupilotmega.msg_ap_adc;
import tcpserver.src.mavlinklib.ardupilotmega.msg_autopilot_version_request;
import tcpserver.src.mavlinklib.ardupilotmega.msg_battery2;
import tcpserver.src.mavlinklib.ardupilotmega.msg_camera_feedback;
import tcpserver.src.mavlinklib.ardupilotmega.msg_camera_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_compassmot_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_data16;
import tcpserver.src.mavlinklib.ardupilotmega.msg_data32;
import tcpserver.src.mavlinklib.ardupilotmega.msg_data64;
import tcpserver.src.mavlinklib.ardupilotmega.msg_data96;
import tcpserver.src.mavlinklib.ardupilotmega.msg_deepstall;
import tcpserver.src.mavlinklib.ardupilotmega.msg_device_op_read;
import tcpserver.src.mavlinklib.ardupilotmega.msg_device_op_read_reply;
import tcpserver.src.mavlinklib.ardupilotmega.msg_device_op_write;
import tcpserver.src.mavlinklib.ardupilotmega.msg_device_op_write_reply;
import tcpserver.src.mavlinklib.ardupilotmega.msg_digicam_configure;
import tcpserver.src.mavlinklib.ardupilotmega.msg_digicam_control;
import tcpserver.src.mavlinklib.ardupilotmega.msg_ekf_status_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_eo_ir_control;
import tcpserver.src.mavlinklib.ardupilotmega.msg_eo_ir_status_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_eoir_status_response;
import tcpserver.src.mavlinklib.ardupilotmega.msg_esc_telemetry_1_to_4;
import tcpserver.src.mavlinklib.ardupilotmega.msg_esc_telemetry_5_to_8;
import tcpserver.src.mavlinklib.ardupilotmega.msg_esc_telemetry_9_to_12;
import tcpserver.src.mavlinklib.ardupilotmega.msg_fence_fetch_point;
import tcpserver.src.mavlinklib.ardupilotmega.msg_fence_point;
import tcpserver.src.mavlinklib.ardupilotmega.msg_fence_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gcs_destination_config;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gcs_destination_config_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gimbal_control;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gimbal_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gimbal_torque_cmd_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gopro_get_request;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gopro_get_response;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gopro_heartbeat;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gopro_set_request;
import tcpserver.src.mavlinklib.ardupilotmega.msg_gopro_set_response;
import tcpserver.src.mavlinklib.ardupilotmega.msg_hwstatus;
import tcpserver.src.mavlinklib.ardupilotmega.msg_led_control;
import tcpserver.src.mavlinklib.ardupilotmega.msg_limits_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_mag_cal_progress;
import tcpserver.src.mavlinklib.ardupilotmega.msg_mag_cal_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_meminfo;
import tcpserver.src.mavlinklib.ardupilotmega.msg_mount_configure;
import tcpserver.src.mavlinklib.ardupilotmega.msg_mount_control;
import tcpserver.src.mavlinklib.ardupilotmega.msg_mount_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_pid_tuning;
import tcpserver.src.mavlinklib.ardupilotmega.msg_pl_network_config;
import tcpserver.src.mavlinklib.ardupilotmega.msg_pl_network_config_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_pl_rf_config;
import tcpserver.src.mavlinklib.ardupilotmega.msg_pl_rf_heartbeat;
import tcpserver.src.mavlinklib.ardupilotmega.msg_pl_rf_status_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_power_pack_data;
import tcpserver.src.mavlinklib.ardupilotmega.msg_radio;
import tcpserver.src.mavlinklib.ardupilotmega.msg_rally_fetch_point;
import tcpserver.src.mavlinklib.ardupilotmega.msg_rally_point;
import tcpserver.src.mavlinklib.ardupilotmega.msg_rangefinder;
import tcpserver.src.mavlinklib.ardupilotmega.msg_remote_log_block_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_remote_log_data_block;
import tcpserver.src.mavlinklib.ardupilotmega.msg_request_sensor_status;
import tcpserver.src.mavlinklib.ardupilotmega.msg_rf_spectrum_data;
import tcpserver.src.mavlinklib.ardupilotmega.msg_roll_pitch_yaw_rates_thrust_setpoint;
import tcpserver.src.mavlinklib.ardupilotmega.msg_roll_pitch_yaw_speed_thrust_setpoint;
import tcpserver.src.mavlinklib.ardupilotmega.msg_roll_pitch_yaw_thrust_setpoint;
import tcpserver.src.mavlinklib.ardupilotmega.msg_rpm;
import tcpserver.src.mavlinklib.ardupilotmega.msg_sensor_data_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_sensor_data_request;
import tcpserver.src.mavlinklib.ardupilotmega.msg_sensor_offsets;
import tcpserver.src.mavlinklib.ardupilotmega.msg_sensor_power_control;
import tcpserver.src.mavlinklib.ardupilotmega.msg_sensor_power_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_set_channel;
import tcpserver.src.mavlinklib.ardupilotmega.msg_set_mag_offsets;
import tcpserver.src.mavlinklib.ardupilotmega.msg_simstate;
import tcpserver.src.mavlinklib.ardupilotmega.msg_status_report;
import tcpserver.src.mavlinklib.ardupilotmega.msg_vision_position_delta;
import tcpserver.src.mavlinklib.ardupilotmega.msg_wind;
import tcpserver.src.mavlinklib.common.*;
import tcpserver.src.mavlinklib.icarous.msg_icarous_heartbeat;
import tcpserver.src.mavlinklib.icarous.msg_icarous_kinematic_bands;
import tcpserver.src.mavlinklib.uAvionix.msg_uavionix_adsb_out_cfg;
import tcpserver.src.mavlinklib.uAvionix.msg_uavionix_adsb_out_dynamic;
import tcpserver.src.mavlinklib.uAvionix.msg_uavionix_adsb_transceiver_health_report;
...
public class MAVLinkPacket implements Serializable {
	...
	public String toString() {
		return "MAVLinkPacket [protocol=" + protocol + ", len=" + len + ", seq=" + seq + ", incompat_flags="
				+ incompat_flags + ", compat_flags=" + compat_flags + ", sysid=" + sysid + ", compid=" + compid
				+ ", msgid=" + msgid + ", payload=" + payload + ", crc_extra=" + crc_extra + ", crc=" + crc + "]";
	}
    ...
    */
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_pl_network_config.MAVLINK_MSG_ID_PL_NETWORK_CONFIG:
                return new msg_pl_network_config(this);
                 
            case msg_pl_rf_config.MAVLINK_MSG_ID_PL_RF_CONFIG:
                return new msg_pl_rf_config(this);
                 
            case msg_pl_network_config_report.MAVLINK_MSG_ID_PL_NETWORK_CONFIG_REPORT:
                return new msg_pl_network_config_report(this);
                 
            case msg_pl_rf_status_report.MAVLINK_MSG_ID_PL_RF_STATUS_REPORT:
                return new msg_pl_rf_status_report(this);
                 
            case msg_pl_rf_heartbeat.MAVLINK_MSG_ID_PL_RF_HEARTBEAT:
                return new msg_pl_rf_heartbeat(this);
                 
            case msg_eo_ir_control.MAVLINK_MSG_ID_EO_IR_CONTROL:
                return new msg_eo_ir_control(this);
                 
            case msg_eo_ir_status_report.MAVLINK_MSG_ID_EO_IR_STATUS_REPORT:
                return new msg_eo_ir_status_report(this);
                 
            case msg_request_sensor_status.MAVLINK_MSG_ID_REQUEST_SENSOR_STATUS:
                return new msg_request_sensor_status(this);
                 
            case msg_sensor_power_control.MAVLINK_MSG_ID_SENSOR_POWER_CONTROL:
                return new msg_sensor_power_control(this);
                 
            case msg_sensor_data_request.MAVLINK_MSG_ID_SENSOR_DATA_REQUEST:
                return new msg_sensor_data_request(this);
                 
            case msg_status_report.MAVLINK_MSG_ID_STATUS_REPORT:
                return new msg_status_report(this);
                 
            case msg_sensor_power_report.MAVLINK_MSG_ID_SENSOR_POWER_REPORT:
                return new msg_sensor_power_report(this);
                 
            case msg_sensor_data_report.MAVLINK_MSG_ID_SENSOR_DATA_REPORT:
                return new msg_sensor_data_report(this);
                 
            case msg_gcs_destination_config.MAVLINK_MSG_ID_GCS_DESTINATION_CONFIG:
                return new msg_gcs_destination_config(this);
                 
            case msg_gcs_destination_config_report.MAVLINK_MSG_ID_GCS_DESTINATION_CONFIG_REPORT:
                return new msg_gcs_destination_config_report(this);
            ...
            case msg_power_pack_data.MAVLINK_MSG_ID_POWER_PACK_DATA:
            	return new msg_power_pack_data(this);
            
            case msg_set_channel.MAVLINK_MSG_ID_SET_CHANNEL:
            	return new msg_set_channel(this);
            	
            case msg_parity_bog_status.MAVLINK_MSG_ID_PARITY_BOG_STATUS:
            	return new msg_parity_bog_status(this);
            ...
            case msg_amp_parts.MAVLINK_MSG_ID_AMP_PARTS:
                return new msg_amp_parts(this);    
                
            case msg_eoir_status_response.MAVLINK_MSG_ID_EOIR_STATUS_RESPONSE:
                return new msg_eoir_status_response(this);    
                
            case msg_rf_spectrum_data.MAVLINK_MSG_ID_RF_SPECTRUM_DATA:
                return new msg_rf_spectrum_data(this);  
            ...
            case msg_gcp_signal.MAVLINK_MSG_ID_GCP_SIGNAL:
            	return new msg_gcp_signal(this);
