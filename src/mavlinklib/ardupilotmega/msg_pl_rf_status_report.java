...
// MESSAGE PL_RF_STATUS_REPORT PACKING
...
/**
* 2.4GHz wireless communication RF setting status.
*/
public class msg_pl_rf_status_report extends MAVLinkMessage{

    public static final int MAVLINK_MSG_ID_PL_RF_STATUS_REPORT = 12004;
    public static final int MAVLINK_MSG_ID_PL_RF_STATUS_REPORT_CRC = 129;
    public static final int MAVLINK_MSG_LENGTH = 37;
    private static final long serialVersionUID = MAVLINK_MSG_ID_PL_RF_STATUS_REPORT;
    ...
    */
    public MAVLinkPacket pack(){
        ...
        packet.sysid = 255;
        packet.compid = 190;
        packet.msgid = MAVLINK_MSG_ID_PL_RF_STATUS_REPORT;
        packet.crc_extra = MAVLINK_MSG_ID_PL_RF_STATUS_REPORT_CRC;
    ...
    /**
    * Decode a pl_rf_status_report message into this class fields
    *
    ...
    */
    public msg_pl_rf_status_report(){
        msgid = MAVLINK_MSG_ID_PL_RF_STATUS_REPORT;
    }
    ...
    *
    */
    public msg_pl_rf_status_report(MAVLinkPacket mavLinkPacket){
        this.sysid = mavLinkPacket.sysid;
        this.compid = mavLinkPacket.compid;
        this.msgid = MAVLINK_MSG_ID_PL_RF_STATUS_REPORT;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_PL_RF_STATUS_REPORT - sysid:"+sysid+" compid:"+compid+" wireless_distance:"+wireless_distance+" radio_enable:"+radio_enable+" channel_bandwidth:"+channel_bandwidth+" channel_frequency:"+channel_frequency+" tx_rf_power:"+tx_rf_power+" mimo:"+mimo+" rf_operation_mode:"+rf_operation_mode+" network_id:"+network_id+" encryption_type:"+encryption_type+" encryption_key:"+encryption_key+" signal2_noise_ratio:"+signal2_noise_ratio+" rf_rssi:"+rf_rssi+"";
    }
}
